...
remote_file "/opt/sensu/embedded/lib/ruby/gems/2.4.0/gems/sensu-transport-snssqs-ng-#{node['monitor']['sensu_gem_versions']['sensu-transport-snssqs-ng']}/lib/sensu/transport/snssqs.rb" do
  source 'https://raw.githubusercontent.com/arvatoaws/sensu-transport-snssqs-ng/master/lib/sensu/transport/snssqs.rb'
  owner 'root'
  group 'root'
  mode '0644'
  action :create
  notifies :create, 'ruby_block[sensu_service_trigger]', :immediately
  only_if { node['monitor']['snssqs_replace_transport'] }
end
